            ...
            <div class="header-widget-2 text-center text-sm-end ">
              ...
              <ul class="header-links">
               <c:if test="${sessionScope.user == null}">
                  <li><a href="login"><i class="fas fa-user"></i> Đăng nhập hoặc
                    đăng ký
                  </a></li>
               </c:if>
                <c:if test="${sessionScope.user != null}">
            ...
            <div class="cart-widget-wrapper slide-down-wrapper">
              <div class="cart-widget slide-down--btn">
                ...
                <div class="cart-text">
                  ...
                  <strong> <span class="amount"><span class="currencySymbol"> 500 VND </strong>
                </div>
              </div>
                  ...
                  <ul class="cart-items">
                    ...
                    <li class="single-cart">
                      <div class="cart-buttons">
                        <a href="cart" class="btn btn-outlined">Xem Giỏ</a>
                        <a href="checkout" class="btn btn-outlined">Thanh toán</a>
                      </div>
                    </li>
                  </ul>
                </div>
