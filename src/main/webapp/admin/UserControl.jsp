...
<aside class="app-sidebar">
  ...
  <ul class="app-menu">
    ...
    <li><a class="app-menu__item active" href="user-control"><i class='app-menu__icon bx bx-user-voice'></i><span
          ...
          <table class="table table-hover table-bordered" id="sampleTable">
            ...
            <c:forEach items="${listU}" var="u">
              <tr>
                ...
                <td>${u.username}</td>
                <td>${u.pass}</td>
                <td>${u.admin == 2 ? "admin":"người dùng"}</td>
                <td><a href="deleteUser?uID=${u.id}" class="btn btn-primary btn-sm trash" title="Xóa"><i class="fas fa-trash-alt"></i>
                </a>
                </td>
              </tr>
            </c:forEach>
