...
<aside class="app-sidebar">
    ...
    <hr>
    <ul class="app-menu">
        <li><a class="app-menu__item active" href="admin-home"><i class='app-menu__icon bx bx-tachometer'></i><span
                            ...
                            <table class="table table-hover">
                                ...
                                <c:forEach items="${listU}" var="u">
                                    <tr>
                                        ...
                                        <td>${u.fullName}</td>
                                        <td>${u.address}</td>
                                        <td><span class="tag tag-success">${u.phoneNum}</span></td>
                                    </tr>
                                </c:forEach>
                                </tbody>
                            </table>
